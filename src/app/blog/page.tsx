...
export const metadata: Metadata = {
  ...
  description:
    'Blog da BEG Destilaria com releases de imprensa, matérias institucionais e conteúdos editoriais de drinks.',
};
    ...
    <main className="min-h-screen bg-[#FCF7F1] text-beggin-ink">
      ...
      <section className="paper-texture bg-[#FCF7F1] px-5 pb-14 pt-[130px] md:px-8 lg:pb-18 lg:pt-[160px]">
        <div className="mx-auto max-w-[1400px] border-b border-[#c8b98e]/55 pb-12 text-center">
          ...
          <h1 className="mx-auto mt-6 max-w-[980px] font-serifDisplay text-[clamp(3.2rem,6.2vw,7.2rem)] font-semibold uppercase leading-[0.86] tracking-[-0.052em]">
            Releases, matérias e drinks.
          </h1>
          <p className="mx-auto mt-7 max-w-[740px] text-[1.08rem] leading-[1.84] text-beggin-ink/72">
            Estrutura editorial preparada para receber releases oficiais de imprensa, histórias da marca e conteúdos de drinks conforme os materiais forem enviados.
          </p>
        </div>
      </section>
      ...
      <section className="paper-texture bg-[#FCF7F1] px-5 pb-20 md:px-8 lg:pb-24">
        <div className="mx-auto grid max-w-[1400px] gap-7 lg:grid-cols-2 xl:grid-cols-3">
          {blogPosts.map((post) => (
            <article key={post.slug} id={post.slug} className="group overflow-hidden border border-[#c8b98e]/60 bg-[#FFFCF6] shadow-[0_20px_54px_rgba(54,43,25,0.06)]">
              <div className="relative h-[300px] overflow-hidden bg-[#e7dfc9]">
                ...
                />
                <span className="absolute left-5 top-5 bg-[#FCF7F1]/92 px-3 py-2 font-serifDisplay text-[10px] font-bold uppercase tracking-[0.16em] text-beggin-ink">
                  {post.status === 'draft' ? 'Em estruturação' : 'Publicado'}
                </span>
              </div>
              <div className="p-7 md:p-8">
                ...
                <Link href={`/blog#${post.slug}`} className="mt-8 inline-flex items-center gap-3 font-serifDisplay text-[12px] font-bold uppercase tracking-[0.18em] text-beggin-ink transition hover:text-beggin-red">
                  Ler conteúdo
                  <ArrowRight size={16} />
                </Link>
              </div>
