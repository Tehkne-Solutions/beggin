...
const menu1 = ['Nossa História', 'Produtos', 'Beg Experience'];
const menu2 = ['Prêmios', 'Sustentabilidade', 'Contato'];
const socials = [
...
export function Footer() {
  ...
  const topMotion = shouldReduceMotion
    ? undefined
    : { x: [0, 28, 0] };
  const bottomMotion = shouldReduceMotion
    ? undefined
    : { x: [0, -32, 0] };
      ...
      <div className="relative z-[2] mx-auto max-w-[1500px] px-5 py-14 sm:px-8 lg:px-10">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.25fr_0.22fr_1px_0.22fr_1px_0.31fr] lg:items-start lg:gap-12">
          ...
          <div className="space-y-4">
            <p className="font-serifDisplay text-[15px] uppercase tracking-[0.08em] text-[#f4efe3]">
              Menu
            </p>
            <div className="space-y-3 text-[14px] font-serifDisplay uppercase tracking-[0.06em] text-[#f4efe3]/85">
              {menu1.map((item) => (
                <a key={item} href="#" className="block transition-colors duration-300 hover:text-[#c8a759]">
                  {item}
                </a>
              ))}
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3 text-[14px] font-serifDisplay uppercase tracking-[0.06em] text-[#f4efe3]/85">
              <a href="#" className="block transition-colors duration-300 hover:text-[#c8a759]">
                Fale Conosco
              </a>
              <a href="mailto:contato@beggin.com.br" className="block transition-colors duration-300 hover:text-[#c8a759]">
                contato@beggin.com.br
              </a>
              <a href="tel:+551999999999" className="block transition-colors duration-300 hover:text-[#c8a759]">
                (19) 99999-9999
              </a>
            </div>
            <div className="flex flex-wrap items-center gap-3 pt-2">
              {socials.map((social) => (
                <a
                  ...
                  className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-[#b99f60]/65 bg-[#1d1f1a]/80 text-[11px] font-semibold uppercase tracking-[0.2em] text-[#b99f60] transition duration-300 hover:border-[#c8a759] hover:text-[#c8a759]"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="mt-14 border-t border-[#9a7a3a]/35 pt-6">
          <div className="flex flex-col gap-4 text-[13px] uppercase tracking-[0.18em] text-[#d6c7a2] sm:flex-row sm:items-center sm:justify-between">
            <p>© 2024 BEG GIN. TODOS OS DIREITOS RESERVADOS.</p>
            <div className="flex flex-wrap items-center justify-center gap-3 text-[#f4efe3]/80">
              <a href="#" className="transition-colors duration-300 hover:text-[#c8a759]">
                {legalLinks[0]}
              </a>
              <span className="text-[#b99f60]">✧</span>
              <a href="#" className="transition-colors duration-300 hover:text-[#c8a759]">
