      ...
      <div className="relative mx-auto max-w-[1560px]">
        <div className="relative z-[2] space-y-12 xl:space-y-14">
          <Reveal className="relative mx-auto max-w-[980px] text-center" delay={0.05}>
            <p className="font-sansUi text-[12px] font-bold uppercase tracking-[0.28em] text-beggin-ink">
              {sustainabilityContent.eyebrow}
            </p>

            <div className="mx-auto mt-4 h-px w-12 bg-beggin-gold/60" />

            <h2 className="mx-auto mt-8 max-w-[940px] font-serifDisplay text-[clamp(3.1rem,4.6vw,6rem)] font-normal uppercase leading-[1.02] tracking-[-0.03em] text-beggin-ink">
            ...
            <MagneticLink
              ...
              className="group mt-9 inline-flex items-center gap-3 font-sansUi text-[12px] font-bold uppercase tracking-[0.18em] text-beggin-ink"
            >
